...
SUBS="_REGION=${REGION},_PRIVATE_ACCESS_TOKEN=${PRIVATE_ACCESS_TOKEN},_PRIVATE_UPLOAD_TOKEN=${PRIVATE_UPLOAD_TOKEN},_CLOUD_RUN_SERVICE=${CLOUD_RUN_SERVICE},_GCP_PROJECT_ID=${GCP_PROJECT_ID},_GCS_BUCKET_NAME=${GCS_BUCKET_NAME},GCS_PUBLIC_BUCKET=${_GCS_PUBLIC_BUCKET},_YAML_IMAGE=${REGION}-docker.pkg.dev/${GCP_PROJECT_ID}/${ARTIFACT_REGISTRY}/${CLOUD_RUN_SERVICE},_S_ACCOUNT_RUN=${SA_NAME_RUN}@${GCP_PROJECT_ID}.iam.gserviceaccount.com,_S_ACCOUNT_STRAVA=${SA_NAME_STRAVA}@${GCP_PROJECT_ID}.iam.gserviceaccount.com,_S_ACCOUNT_DROPBOX=${SA_NAME_DROPBOX}@${GCP_PROJECT_ID}.iam.gserviceaccount.com"
