...
dotenv_path = os.path.join(os.path.dirname(__file__), "/home/stas/Dropbox/projects/BigBikeData/dropbox_bucket_strava/project_env/keys.env")
...
if __name__ == "__main__":
    # 🚨 CRITICAL: REPLACE THIS PATH with the actual, absolute path
    # used by your PyCharm configuration.
    # Example Path:
    ENV_FILE = os.path.expanduser('/home/stas/Dropbox/projects/BigBikeData/dropbox_bucket_strava/project_env/keys.env')
