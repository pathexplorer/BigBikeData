...
dotenv_path = os.path.join(os.path.dirname(__file__), "/home/stas/Dropbox/projects/BigBikeData/power_core/project_env/keys.env")
...
if __name__ == "__main__":
    ...
    ENV_FILE = os.path.expanduser('/home/stas/Dropbox/projects/BigBikeData/power_core/project_env/keys.env')
