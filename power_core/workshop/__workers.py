...
from power_core.strava.upload import *
...
# ----- load FIT to Virtual Machine(AKA "local") -----
    ...
    path = f"{GSC_ORIG_FIT_FOLDER}/{filename}" # Exclude gs:// part from path: simple build new path from variables
    download_from_gcp_bucket(bucket_name, path, local_fit,"blob")
...
# ----- FIT >>> Unexplored CSV
    ...
    #upload_to_gcp_bucket(bucket_name, csv_gcs_path, local_csv, "filename")
